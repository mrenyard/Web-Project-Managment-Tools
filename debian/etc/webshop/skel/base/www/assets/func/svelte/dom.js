...
SVELTE.dom = function() {
  ...
  /**
   */
  var _build = function(type,h,t,cN)
  {
  ...
  /**
   */
  var _buildSection = function(h, t, cN)
  {
    var _s = _build('section',h,t,cN);
    return {
      getNode: _s,
  ...
  return {
    Section: function(heading, title, className, children) {
      return _buildSection(heading, title, className, children);
    },
